...
export default function Navbar() {
  ...
  const handleCategoryClick = (category, section, item, close) => {
    // close mobile dialog first
    setOpen(false);

    // if called from Popover render-prop, close that too
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#" onClick={() => navigate('/')}>
                  ...
                  <img
                    alt=""
                    src="https://w7.pngwing.com/pngs/426/341/png-transparent-shopping-cart-e-commerce-online-shopping-logo-shopping-cart-blue-service-logo.png"
