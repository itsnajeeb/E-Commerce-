...
import { filter, singleFilter, sortOptions } from './FilterData'
...
export default function Product() {
    ...
    useEffect(() => {
        const [minPrice, maxPrice] =
            priceValue && priceValue.includes("-")
                ? priceValue.split("-").map(Number)
                : [0, 10000]; // default price range

        const data = {
            category: param?.levelThree || "all",
                    ...
                    <div className="fixed inset-0 z-40 flex">
                        ...
                        >
                            ...
                            <form className="mt-4 border-t border-gray-200">
                                ...
                                {filter.map((section, idx) => (
                                    <Disclosure key={idx} as="div" className="border-t border-gray-200 px-4 py-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                <div className='flex justify-between items-center py-8'>
                                    <h1 className='text-xl font-semibold mb-1'>Filters</h1>
                                    <FilterListAltIcon className='text-gray-500' />
                                </div>


                                {filter.map((section, idx) => (
                                    <Disclosure key={idx} as="div" className="border-b border-gray-200 py-6">
                                        ...
                                        <>
                                            <h3 className="-my-3 flow-root">
                                                <DisclosureButton className=" cursor-pointer group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                                                    ...
                                                    <FormLabel
                                                        sx={{ color: "black" }}
                                                        className="font-medium text-gray-900" id="demo-radio-buttons-group-label">{section.name}</FormLabel>
                                                    <span className="ml-6 flex items-center">
                                                        <PlusIcon aria-hidden="true" className="size-5 group-data-open:hidden" />
                                                        <MinusIcon aria-hidden="true" className="size-5 group-not-data-open:hidden" />
                                                    </span>
                                                            ...
                                                            {section.options.map((option, optionIdx) => (
                                                                <>
                                                                    <FormControlLabel
                                                                        ...
                                                                        key={optionIdx} value={option.value} control={<Radio />} label={option.label} />
                                                                </>
